...
export const KO: Record<UIKey, string> = {
  ...
  menuItemsHint: "드래그로 순서 변경, 이 버튼에 겹치면 삭제", reorder: "드래그하여 순서 변경", splitMain: "주 동작", splitMenu: "화살표(메뉴)", selectDate: "날짜 선택",
