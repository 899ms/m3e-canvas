...
export const UI = {
  ...
  deleteKey: { ja: "削除 (Delete)", en: "Delete (Delete)", zh: "删除 (Delete)" },
  ...
  contentWidthHint: {
    ja: "画面の左右に 16dp の余白を残した幅（M3 のレイアウトマージン）",
    en: "The width left when 16dp margins are kept at both screen edges (the M3 layout margin)",
    zh: "在屏幕左右各留 16dp 边距后的宽度（M3 的布局边距）",
  },
  screenWidthHint: { ja: "画面の端から端まで", en: "Edge to edge across the screen", zh: "从屏幕一端到另一端" },
  halfWidthHint: { ja: "余白の中で 2 つ並べたときの幅", en: "One of two that share a row inside the margins", zh: "在留边内并排放两个时的宽度" },
  autoWidthHint: { ja: "文字とアイコンに合わせた幅", en: "As wide as the label and icon need", zh: "按文字和图标自适应的宽度" },
  ...
  dragArrow: { ja: "ここから矢印を引く", en: "Drag an arrow from here", zh: "从这里拖出箭头" },
  removeArrow: { ja: "矢印を外す", en: "Remove the arrow", zh: "移除箭头" },
  recenter: { ja: "中央に戻す", en: "Recenter", zh: "回到中央" },
  ...
  dateExample: { ja: "3月17日（月）", en: "Mon, Mar 17", zh: "3月17日 周一" },
  monthExample: { ja: "2026年3月", en: "March 2026", zh: "2026年3月" },
  hourLabel: { ja: "時", en: "Hour", zh: "时" },
  minuteLabel: { ja: "分", en: "Minute", zh: "分" },
  layout: { ja: "表示", en: "Layout", zh: "布局" },
  carouselMultiBrowse: { ja: "マルチ", en: "Multi-browse", zh: "多浏览" },
  carouselUncontained: { ja: "均等", en: "Uncontained", zh: "等宽" },
  ...
  timeInput: { ja: "入力欄", en: "Input", zh: "输入框" },
  cards: { ja: "カード", en: "Cards", zh: "卡片" },
  selectedDay: { ja: "選択中の日", en: "Selected day", zh: "选中的日期" },
  linkUrl: { ja: "リンク先の URL", en: "Link URL", zh: "链接地址" },
  linkInvalid: { ja: "http または https で始まる URL を入力してください", en: "Enter a URL starting with http or https", zh: "请输入以 http 或 https 开头的网址" },
...
export const KO: Record<UIKey, string> = {
  ...
  duplicate: "복제", more: "더보기", duplicateKey: "복제 (Ctrl+D)", delete: "삭제", deleteKey: "삭제 (Delete)", deleteSelection: "선택 항목 삭제",
  ...
  contentWidthHint: "화면 좌우에 16dp 여백을 남긴 너비(M3 레이아웃 여백)", screenWidthHint: "화면 끝에서 끝까지", halfWidthHint: "여백 안에 둘을 나란히 놓았을 때의 너비", autoWidthHint: "글자와 아이콘에 맞춘 너비", screenHeight: "화면 높이", halfHeight: "화면의 절반",
...
> = {
  ja: {
    ...
    linearProgress: { noun: "プログレス" },
    circularProgress: { noun: "プログレス" },
  ...
  en: {
    ...
    linearProgress: { noun: "progress" },
    circularProgress: { noun: "progress" },
  ...
  zh: {
    ...
    linearProgress: { noun: "进度" },
    circularProgress: { noun: "进度" },
  ...
  ko: {
    ...
    linearProgress: { noun: "진행률" },
    circularProgress: { noun: "진행률" },
