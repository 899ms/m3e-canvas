...
export const KO: Record<UIKey, string> = {
  ...
  design: "디자인", trigger: "트리거", noteDialog: "버튼 사양", toggleLookHint: "디자인 탭에서 꾸밀 수 있습니다", addFrameHint: "화면을 추가하면 여기서 이동을 설정할 수 있습니다", replay: "다시 재생", toggleTitle: "전환", whenPressedExample: "예: 저장하고 목록으로 돌아가기", dragArrow: "여기서 화살표 끌기", removeArrow: "화살표 제거", recenter: "가운데로", resizeWidth: "드래그하여 너비 변경", resizeHeight: "드래그하여 높이 변경", openLink: "링크 열기", linkUrl: "링크 URL", linkInvalid: "http 또는 https로 시작하는 URL을 입력하세요", linkBrowser: "브라우저", shapeScale: "모서리 둥글기", shapeSquare: "사각형", shapeRounded: "둥근형", shapeFull: "완전 둥근형",
